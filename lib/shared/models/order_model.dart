...
class OrderModel {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'status': status, 'riderId': riderId, 'paymentMethod': paymentMethod,
      'isPaid': isPaid, 'deliveryAddress': deliveryAddress,
      'deliveryLatitude': deliveryLatitude, 'deliveryLongitude': deliveryLongitude,
      'customerPhone': customerPhone, 'specialInstructions': specialInstructions,
